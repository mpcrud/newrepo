...
public abstract class AuthUserUserPermissions_ {
    ...
    public static volatile SingularAttribute<AuthUserUserPermissions, Integer> userId;
    public static volatile SingularAttribute<AuthUserUserPermissions, Integer> permissionId;
}