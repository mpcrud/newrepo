...
public abstract class AuthGroupPermissions_ {
    ...
    public static volatile SingularAttribute<AuthGroupPermissions, Integer> groupId;
    public static volatile SingularAttribute<AuthGroupPermissions, Integer> permissionId;
}