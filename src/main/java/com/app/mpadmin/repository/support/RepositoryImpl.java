 ...
 */
package com.app.mpadmin.repository.support;
...
import com.app.mpadmin.dao.support.SearchMode;
...
public abstract class RepositoryImpl<T extends Identifiable<PK>, PK extends Serializable> implements Repository<T, PK> {
    ...
    public List<T> find(String query) {
        return find(new SearchParameters(SearchMode.STARTING_LIKE).withSearchPattern(query));
    }
