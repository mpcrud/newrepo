 ...
 */
public class TdTagRelationLazyDataModel extends GenericLazyDataModel<TdTagRelation> {
    private static final long serialVersionUID = 1L;

    @Inject
    transient private TdTagRelationRepository tdTagRelationRepository;
    @Inject
     ...
     */
    @Override
    public List<TdTagRelation> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, String> filters) {
        SearchParameters sp = tdTagRelationSearchForm.getSearchParameters();
        ...
        sp.addEntitySelector(tdTagRelationSearchForm.getParentTagSelector());
        sp.addEntitySelector(tdTagRelationSearchForm.getCurrentTagSelector());
