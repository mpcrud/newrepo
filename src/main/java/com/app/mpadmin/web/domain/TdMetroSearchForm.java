...
/**
 * Simple parameters holder for tdMetro search.
 */
@Component
@Scope("session")
public class TdMetroSearchForm extends SearchFormBase {
    private static final long serialVersionUID = 1L;

    private TdMetro tdMetro = new TdMetro();
    ...
    public RangeInteger<TdMetro> getFlagRange() {
        return flagRange;
    }

    public RangeDate<TdMetro> getUpdationDateRange() {
