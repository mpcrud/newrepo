...
/**
 * Responsible for creating TdCountry JSF converters.
 ...
 */
@Component
public class TdCountryConverter extends GenericJsfConverter<TdCountry, Integer> {
    @Inject
    public TdCountryConverter(TdCountryRepository tdCountryRepository) {
        super(tdCountryRepository, Integer.class);
    }

    @Override
    public String print(TdCountry tdCountry) {
        return tdCountry == null ? "" : "" + tdCountry.getCountryName();
    }
}