...
/**
 * Responsible for creating TdPicture JSF converters.
 ...
 */
@Component
public class TdPictureConverter extends GenericJsfConverter<TdPicture, Integer> {
    @Inject
    public TdPictureConverter(TdPictureRepository tdPictureRepository) {
        super(tdPictureRepository, Integer.class);
    }

    @Override
    public String print(TdPicture tdPicture) {
        return tdPicture == null ? "" : "" + tdPicture.getPictureName();
    }
}