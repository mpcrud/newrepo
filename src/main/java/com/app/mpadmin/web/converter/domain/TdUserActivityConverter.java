...
/**
 * Responsible for creating TdUserActivity JSF converters.
 ...
 */
@Component
public class TdUserActivityConverter extends GenericJsfConverter<TdUserActivity, Integer> {
    @Inject
    public TdUserActivityConverter(TdUserActivityRepository tdUserActivityRepository) {
        super(tdUserActivityRepository, Integer.class);
    }

    @Override
    public String print(TdUserActivity tdUserActivity) {
        return tdUserActivity == null ? "" : "" + tdUserActivity.getIpaddress();
    }
}