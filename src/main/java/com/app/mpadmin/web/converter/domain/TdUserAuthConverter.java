...
/**
 * Responsible for creating TdUserAuth JSF converters.
 ...
 */
@Component
public class TdUserAuthConverter extends GenericJsfConverter<TdUserAuth, Integer> {
    @Inject
    public TdUserAuthConverter(TdUserAuthRepository tdUserAuthRepository) {
        super(tdUserAuthRepository, Integer.class);
    }
