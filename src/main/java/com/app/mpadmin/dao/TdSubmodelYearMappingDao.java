...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdSubmodelYearMapping}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdSubmodelYearMappingDao extends GenericDao<TdSubmodelYearMapping, Integer> {
    public TdSubmodelYearMappingDao() {
        super(TdSubmodelYearMapping.class);
    }
}