...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdRequestCarPart}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdRequestCarPartDao extends GenericDao<TdRequestCarPart, Integer> {
    public TdRequestCarPartDao() {
        super(TdRequestCarPart.class);
    }
}