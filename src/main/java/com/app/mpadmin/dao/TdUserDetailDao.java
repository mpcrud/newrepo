...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdUserDetail}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdUserDetailDao extends GenericDao<TdUserDetail, Integer> {
    public TdUserDetailDao() {
        super(TdUserDetail.class);
    }
}