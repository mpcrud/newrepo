...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdUserAuth}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdUserAuthDao extends GenericDao<TdUserAuth, Integer> {
    public TdUserAuthDao() {
        super(TdUserAuth.class);
    }
}