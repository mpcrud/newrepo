...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdShipmentVendor}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdShipmentVendorDao extends GenericDao<TdShipmentVendor, Integer> {
    public TdShipmentVendorDao() {
        super(TdShipmentVendor.class);
    }
}