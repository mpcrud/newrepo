...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdPermission}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdPermissionDao extends GenericDao<TdPermission, Integer> {
    public TdPermissionDao() {
        super(TdPermission.class);
    }
}