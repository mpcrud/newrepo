...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdTagRelation}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdTagRelationDao extends GenericDao<TdTagRelation, Integer> {
    public TdTagRelationDao() {
        super(TdTagRelation.class);
    }
}