...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdProductBrand}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdProductBrandDao extends GenericDao<TdProductBrand, Integer> {
    public TdProductBrandDao() {
        super(TdProductBrand.class);
    }
}