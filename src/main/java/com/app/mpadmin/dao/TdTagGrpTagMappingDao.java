...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdTagGrpTagMapping}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdTagGrpTagMappingDao extends GenericDao<TdTagGrpTagMapping, Integer> {
    public TdTagGrpTagMappingDao() {
        super(TdTagGrpTagMapping.class);
    }
}