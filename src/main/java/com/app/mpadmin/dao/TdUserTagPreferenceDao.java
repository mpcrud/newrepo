...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdUserTagPreference}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdUserTagPreferenceDao extends GenericDao<TdUserTagPreference, Integer> {
    public TdUserTagPreferenceDao() {
        super(TdUserTagPreference.class);
    }
}