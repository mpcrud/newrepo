...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.AuthPermission}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class AuthPermissionDao extends GenericDao<AuthPermission, Integer> {
    public AuthPermissionDao() {
