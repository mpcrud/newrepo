...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.AuthGroupPermissions}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class AuthGroupPermissionsDao extends GenericDao<AuthGroupPermissions, Integer> {
    public AuthGroupPermissionsDao() {
