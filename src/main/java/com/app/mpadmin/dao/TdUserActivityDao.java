...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdUserActivity}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdUserActivityDao extends GenericDao<TdUserActivity, Integer> {
    public TdUserActivityDao() {
        super(TdUserActivity.class);
    }
}