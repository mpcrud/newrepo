...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TdUserAddress}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TdUserAddressDao extends GenericDao<TdUserAddress, Integer> {
    public TdUserAddressDao() {
        super(TdUserAddress.class);
    }
}