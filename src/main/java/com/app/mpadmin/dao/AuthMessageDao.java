...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.AuthMessage}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class AuthMessageDao extends GenericDao<AuthMessage, Integer> {
    public AuthMessageDao() {
        super(AuthMessage.class);
    }
}