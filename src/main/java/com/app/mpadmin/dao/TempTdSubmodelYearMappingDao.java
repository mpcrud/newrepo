...
/**
 * JPA 2 Data Access Object for {@link com.app.mpadmin.domain.TempTdSubmodelYearMapping}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class TempTdSubmodelYearMappingDao extends GenericDao<TempTdSubmodelYearMapping, Integer> {
    public TempTdSubmodelYearMappingDao() {
        super(TempTdSubmodelYearMapping.class);
    }
}